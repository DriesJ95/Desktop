...
public class JDBCTest {
   ...
   public void testTransaction() throws SQLException {
      String SQL1 = "UPDATE Beers SET Stock=? WHERE Name ='Jupiler'";
      String SQL2 = "UPDATE Beers SET Stock=? WHERE Name ='Piraat'";

      String SQL = "SELECT Stock from Beers WHERE Name = 'Jupiler' OR Name = 'Piraat'";
      ...
      try (PreparedStatement stmt1 = con.prepareStatement(SQL1);
         ...
         stmt1.setInt(1, 200);
         stmt2.setInt(1, 200);
         stmt1.executeUpdate(); // Transaction start
         stmt2.executeUpdate();
